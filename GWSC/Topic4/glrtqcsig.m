function glrt = glrtqcsig(dataVec, psdPosFreq, params)
...
%glrt = Glrtqcsig(dataVec, psdPosFreq, params)
%Inputs:dataVec is the data vector.psdPosFreq is the PSD vector (for 
%positive DFT frequencies).And params is the vector of input parameters
%[a1, a2, a3].
%Output is the glrt value.
